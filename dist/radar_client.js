(function() {
    ...
    aaa = function(tag, str){
      console.log("ZB " + tag + " (" + Date.now() + ") %c" + str, 'color: #008855')
    }
    require.m = [];
    require.m[0] = {
        "engine.io-client": {
        ...
        "lib/backoff.js": function(module, exports, require) {
            function Backoff() {
                this.failures = 0;
            }
        ...
        "lib/radar_client.js": function(module, exports, require) { /* globals setImmediate */
            ...
            var init = function(propertyName) {
                Client.prototype[propertyName] = function(scope, options, callback) {
                    ...
                    if ((propertyName == 'sync' || propertyName == 'synced') && !message.options && scope.match(/^presence.+/)) {
                        message.options = {
                            version: 2
                        };
        ...
        "lib/scope.js": function(module, exports, require) {
            ...
            function create() {
                    ...
                    machine = Machine.create({
                        ...
                        callbacks: {
                            ...
                            onconnecting: function() {
                                aaa(6424, "onconnecting and start guard.")
                                this.startGuard();
                            },
                            ...
                            ondisconnected: function(event, from, to) {
                                ...
                                this._timer = setTimeout(function() {
                                    ...
                                    aaa(6346,'Retry timer up and machine state is ' + machine.current + '.')
                ...
                machine.startGuard = function() {
                    ...
                    machine._guard = setTimeout(function() {
                        ...
                        aaa(4573, "Start Guard up and disconnect.")
                        machine.disconnect();
    ...
    require.m[2] = {
        "/demo/demo.js": function(module, exports, require) {
            Demo = function() {
