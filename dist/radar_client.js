(function() {
    var aaa;
    aaa = function() {
      var arg, color, index, newarg, _len;
      color = 'color: #990099';
      if (arguments.length === 0) {
        return;
      }
      if (arguments.length === 1) {
        console.log("%c " + arguments[0], color);
      }
      if (arguments.length === 2) {
        if (typeof arguments[1] === 'string') {
          console.log("%c ZB " + arguments[0] + " " + arguments[1], color);
        } else {
          console.log("%c ZB " + arguments[0], color, (arguments[1]));
        }
      }
      if (arguments.length > 2) {
        newarg = [];
        if (typeof arguments[1] === 'string') {
          newarg.push("%c ZB " + arguments[0] + " " + arguments[1]);
          newarg.push(color);
        } else {
          newarg.push("%c ZB " + arguments[0]);
          newarg.push(color);
          newarg.push((arguments[1]));
        }
        for (index = 0, _len = arguments.length; index < _len; index++) {
          arg = arguments[index];
          if (index < 2) {
            continue;
          }
        ...
        return console.log.apply(console, newarg);
      }
    };
    ...
    var r = function() {
        var e = "function" == typeof require && require,
            r = function(i, o, u) {
                ...
                return t.exports || (t.exports = {}, t.call(t.exports, t, t.exports, r.relative(n, o))), t.exports
            };
    ...
    r.m[0] = {
        ...
        "scope.js": function(module, exports, require) {
            ...
            var props = ['history', 'set', 'get', 'subscribe', 'unsubscribe', 'publish',
                'push', 'sync', 'synced', 'on', 'once', 'when', 'removeListener', 'removeAllListeners', 'nameSync'
            ];
            ...
            function create() {
                var backoff = new Backoff(),
                    machine = Machine.create({
                        ...
                        events: [{
                            ...
                            name: 'activate',
                            from: ['authenticating', 'activated'],
                            to: 'activated'
                        }, {
                            name: 'disconnect',
                            from: Machine.WILDCARD,
                            to: 'disconnected'
                        }, {
                            name: 'close',
                            from: Machine.WILDCARD,
                        ...
                        callbacks: {
                            ...
                            ondisconnected: function(event, from, to) {
                                ...
                                this._timer = setTimeout(function() {
                                    ...
                                    aaa(5667, "Retry timer up! current: " + machine.current)
                ...
                machine.connectWhenAble = function() {
                    if (!(this.is('connected') || this.is('activated'))) {
                        if (this.can('connect')) {
                            //aaa(2467,"start to try to connect current:", this.current)
                            this.connect();
                        } else {
        ...
        "radar_client.js": function(module, exports, require) {
            ...
            Client.prototype.configure = function(hash) {
                var configuration = hash || this._configuration || {
                    accountName: '',
                    userId: 0,
                    userType: 0
                };
            ...
            Client.prototype._write = function(request, callback) {
                ...
                reqMessage.tokenId = tokenId;
                reqMessage.clientTimeID = clientTimeID;
                this.emit('authenticateMessage', reqMessage);
            ...
            Client.prototype._batched = function(response) {
                ...
                if (!response.isValid()) {
                    aaa(1267, 'invalid batched', to, value, time)
                    this.logger().info('response is invalid:', response.getMessage());
                    return false;
                }
            ...
            Client.prototype._createManager = function() {
                var self = this,
                    manager = this.manager = StateMachine.create();
            ...
            Client.prototype._sendMessage = function(request) {
                ...
                if (this._socket && this.manager.is('activated')) {
                    ...
                    this._identitySetRequired = true;
                    //aaa(4567, "_sendMessage: memorized: " + memorized + "; ack: " + ack)
                    if (!memorized || ack) {
            ...
            Client.setBackend = function(lib) {
                eio = lib;
            };
    ...
    r.m[4] = {
        ...
        "package.json": function(module, exports, require) {
            module.exports = {
                ...
                "_resolved": "http://registry.npmjs.org/sfsm/-/sfsm-0.0.4.tgz"
            };
        },
    ...
    r.m[5] = {
        ...
        "package.json": function(module, exports, require) {
            module.exports = {
                ...
                "_resolved": "http://registry.npmjs.org/microee/-/microee-0.0.6.tgz",
                "readme": "ERROR: No README data found!",
                "homepage": "https://github.com/mixu/microee#readme"
            };
        }
    };
    r.m[6] = {
        ...
        "package.json": function(module, exports, require) {
            module.exports = {
                ...
                "directories": {},
                "_resolved": "http://registry.npmjs.org/radar_message/-/radar_message-1.0.1.tgz"
            };
        },
